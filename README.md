...
Versione online multiplayer del gioco di carte Carioca (10 mani), giocabile con gli amici da dispositivi diversi tramite un codice stanza.
...
- Chi vince una mano (rimane senza carte) prende **-10 punti** (una penalità negativa, quindi un bonus).
- Se chi vince la mano è anche chi l'ha scelta, prende **-20 punti** invece di -10.
- Se chi ha scelto la **Bomba** l'ha scelta **al buio** (senza guardare prima le proprie carte) e la vince, prende **-40 punti**.
- Tutti gli altri giocatori sommano i punti delle carte rimaste in mano (non calate): 2-10 valore nominale, figure e Asso 10 punti, Jolly 25 punti.
- Vince la partita chi, dopo le 10 mani, ha il **totale più basso**.
- In ogni momento della partita si può aprire il pulsante **"Risultati"** per vedere lo storico completo mano per mano, con una piccola corona 👑 accanto al punteggio di chi ha vinto ciascuna mano.

## Limiti di questa versione

- **Nessun database**: le partite vivono in memoria sul server. Se il server si riavvia (es. dopo lunga inattività su Render), le stanze aperte vengono perse e bisogna ricominciare.
- **Riconnessione automatica**: se un giocatore perde la connessione, ricarica la pagina per errore, o cambia rete (tipico su mobile), il browser ricorda la stanza e riprende automaticamente il proprio posto nella partita, allo stesso punto in cui era rimasta — a patto che il server non sia stato riavviato nel frattempo.
- **Fino a 6 giocatori** per stanza, come nella versione hotseat.

## Le regole di gioco implementate

Le stesse 10 mani della versione hotseat: Coppia Vestita, Doppia Coppia, Tris, Full, Poker, Scala Reale, Chiusura, Bomba, Trik Trak, Scala 40 — con tutte le regole su jolly, divieti di scarto/attacco su J/Q/K/A e 5/10, e punteggio finale a chi totalizza meno punti dopo le 10 mani.
